...
namespace Instituicao.Controllers
{
    public class DisciplinasController : Controller
    {
        ...
        {
            ViewData["ProMatricula"] = new SelectList(_context.Professores, "ProMatricula", "ProMatricula");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("DisID,DisNome,DisHoras,ProMatricula")] Disciplina disciplina)
        {
            ...
            ViewData["ProMatricula"] = new SelectList(_context.Professores, "ProMatricula", "ProMatricula", disciplina.ProMatricula);
            return View(disciplina);
        }
